...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkAudioSession>()
{
	...
	struct Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_1463653249(TEXT("/Script/AkAudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PWM_SDK_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo));
